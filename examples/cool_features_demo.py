...
from structlite import Struct, async_validator, immutable, transformer, validator
...
async def demo_transformers():
    ...
    print(
        f"Original input: name='  john doe  ', birth_date='1990-05-15', email='JOHN.DOE@EXAMPLE.COM'"
    )
